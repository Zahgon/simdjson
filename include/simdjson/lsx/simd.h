...
namespace simd {
  ...
  struct base {
    ...
    simdjson_inline operator const v16i8&() const { __builtin_trap() /* STUB: not implemented */; }
    simdjson_inline operator v16i8&() { __builtin_trap() /* STUB: not implemented */; }
  ...
  struct simd8<bool>: base8<bool> {
    ...
    simdjson_inline simd8(const __m128i _value) : base8<bool>(_value) { __builtin_trap() /* STUB: not implemented */; }
    // Splat constructor
  ...
  struct simd8<int8_t> : base8_numeric<int8_t> {
    ...
    simdjson_inline simd8(const __m128i _value) : base8_numeric<int8_t>(_value) { __builtin_trap() /* STUB: not implemented */; }
    // Splat constructor
    simdjson_inline simd8(int8_t _value) : simd8(splat(_value)) { __builtin_trap() /* STUB: not implemented */; }
    // Array constructor
    simdjson_inline simd8(const int8_t values[16]) : simd8(load(values)) { __builtin_trap() /* STUB: not implemented */; }
  ...
  struct simd8<uint8_t>: base8_numeric<uint8_t> {
    ...
    simdjson_inline simd8(const __m128i _value) : base8_numeric<uint8_t>(_value) { __builtin_trap() /* STUB: not implemented */; }
    // Splat constructor
