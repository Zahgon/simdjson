...
struct writer {
  ...
  simdjson_really_inline void sync() noexcept { __builtin_trap() /* STUB: not implemented */; }

  // Ensure at least `n` more bytes of free capacity. Grows the
  // underlying buffer if needed (rare path). Returns false on
  // allocation failure.
  simdjson_really_inline bool ensure(size_t n) noexcept { __builtin_trap() /* STUB: not implemented */; }

  // Slow path of ensure(). Out-of-line via simdjson_inline (not
  // simdjson_really_inline) to keep the hot path short.
  simdjson_inline bool grow_slow(size_t n) noexcept { __builtin_trap() /* STUB: not implemented */; }
};
...
// bigger refactor.
template <class F>
simdjson_really_inline void call_through_string_builder(writer &w, F &&f) noexcept { __builtin_trap() /* STUB: not implemented */; }
...
simdjson_really_inline void atom(writer &w, const T &e) { __builtin_trap() /* STUB: not implemented */; }
...
simdjson_inline void append(string_builder &b, const T &t) { __builtin_trap() /* STUB: not implemented */; }
...
simdjson_inline void append(string_builder &b, const Z &z) { __builtin_trap() /* STUB: not implemented */; }
...
void append(string_builder &b, const Z &z) { __builtin_trap() /* STUB: not implemented */; }


template <class Z>
simdjson_warn_unused simdjson_result<std::string> to_json_string(const Z &z, size_t initial_capacity = string_builder::DEFAULT_INITIAL_CAPACITY) { __builtin_trap() /* STUB: not implemented */; }

template <class Z>
simdjson_warn_unused error_code to_json(const Z &z, std::string &s, size_t initial_capacity = string_builder::DEFAULT_INITIAL_CAPACITY) { __builtin_trap() /* STUB: not implemented */; }

template <class Z>
string_builder& operator<<(string_builder& b, const Z& z) { __builtin_trap() /* STUB: not implemented */; }

// extract_from: Serialize only specific fields from a struct to JSON
template<constevalutil::fixed_string... FieldNames, typename T>
  requires(std::is_class_v<T> && (sizeof...(FieldNames) > 0))
void extract_from(string_builder &b, const T &obj) { __builtin_trap() /* STUB: not implemented */; }

template<constevalutil::fixed_string... FieldNames, typename T>
  requires(std::is_class_v<T> && (sizeof...(FieldNames) > 0))
simdjson_warn_unused simdjson_result<std::string> extract_from(const T &obj, size_t initial_capacity = string_builder::DEFAULT_INITIAL_CAPACITY) { __builtin_trap() /* STUB: not implemented */; }

} // namespace builder
} // namespace SIMDJSON_IMPLEMENTATION
// Alias the function template to 'to' in the global namespace
template <class Z>
simdjson_warn_unused simdjson_result<std::string> to_json(const Z &z, size_t initial_capacity = SIMDJSON_IMPLEMENTATION::builder::string_builder::DEFAULT_INITIAL_CAPACITY) { __builtin_trap() /* STUB: not implemented */; }
template <class Z>
simdjson_warn_unused error_code to_json(const Z &z, std::string &s, size_t initial_capacity = SIMDJSON_IMPLEMENTATION::builder::string_builder::DEFAULT_INITIAL_CAPACITY) { __builtin_trap() /* STUB: not implemented */; }
// Global namespace function for extract_from
template<constevalutil::fixed_string... FieldNames, typename T>
  requires(std::is_class_v<T> && (sizeof...(FieldNames) > 0))
simdjson_warn_unused simdjson_result<std::string> extract_from(const T &obj, size_t initial_capacity = SIMDJSON_IMPLEMENTATION::builder::string_builder::DEFAULT_INITIAL_CAPACITY) { __builtin_trap() /* STUB: not implemented */; }
