...
namespace simd {
  ...
  struct base {
    ...
    // Zero constructor
    simdjson_inline base() : value{__m256i()} { __builtin_trap() /* STUB: not implemented */; }

    // Conversion from SIMD register
    simdjson_inline base(const __m256i _value) : value(_value) { __builtin_trap() /* STUB: not implemented */; }

    // Conversion to SIMD register
    simdjson_inline operator const __m256i&() const { __builtin_trap() /* STUB: not implemented */; }
    simdjson_inline operator __m256i&() { __builtin_trap() /* STUB: not implemented */; }
  ...
  struct base8: base<simd8<T>> {
    ...
    friend simdjson_really_inline Mask operator==(const simd8<T> lhs, const simd8<T> rhs) { __builtin_trap() /* STUB: not implemented */; }
  ...
  struct simd8<bool>: base8<bool> {
    ...
    simdjson_inline simd8() : base8() { __builtin_trap() /* STUB: not implemented */; }
    simdjson_inline simd8(const __m256i _value) : base8<bool>(_value) { __builtin_trap() /* STUB: not implemented */; }
    // Splat constructor
    simdjson_inline simd8(bool _value) : base8<bool>(splat(_value)) { __builtin_trap() /* STUB: not implemented */; }
  ...
  struct base8_numeric: base8<T> {
    static simdjson_inline simd8<T> splat(T _value) { __builtin_trap() /* STUB: not implemented */; }
    static simdjson_inline simd8<T> zero() { __builtin_trap() /* STUB: not implemented */; }
    static simdjson_inline simd8<T> load(const T values[32]) { __builtin_trap() /* STUB: not implemented */; }
    ...
    // Store to array
    simdjson_inline void store(T dst[32]) const { __builtin_trap() /* STUB: not implemented */; }
    ...
    template<typename L>
    simdjson_inline void compress(uint32_t mask, L * output) const { __builtin_trap() /* STUB: not implemented */; }
  ...
  struct simd8<int8_t> : base8_numeric<int8_t> {
    ...
    simdjson_inline simd8(const __m256i _value) : base8_numeric<int8_t>(_value) { __builtin_trap() /* STUB: not implemented */; }
    // Splat constructor
    simdjson_inline simd8(int8_t _value) : simd8(splat(_value)) { __builtin_trap() /* STUB: not implemented */; }
    // Array constructor
    simdjson_inline simd8(const int8_t values[32]) : simd8(load(values)) { __builtin_trap() /* STUB: not implemented */; }
  ...
  struct simd8<uint8_t>: base8_numeric<uint8_t> {
    ...
    simdjson_inline simd8(const __m256i _value) : base8_numeric<uint8_t>(_value) { __builtin_trap() /* STUB: not implemented */; }
    // Splat constructor
    simdjson_inline simd8(uint8_t _value) : simd8(splat(_value)) { __builtin_trap() /* STUB: not implemented */; }
    // Array constructor
    simdjson_inline simd8(const uint8_t values[32]) : simd8(load(values)) { __builtin_trap() /* STUB: not implemented */; }
    // Member-by-member initialization
    simdjson_inline simd8(
    ...
    template<int N>
    simdjson_inline int get_bit() const { __builtin_trap() /* STUB: not implemented */; }
  };
  ...
  struct simd8x64 {
    ...
    simdjson_inline simd8x64(const simd8<T> chunk0, const simd8<T> chunk1) : chunks{chunk0, chunk1} { __builtin_trap() /* STUB: not implemented */; }
    simdjson_inline simd8x64(const T ptr[64]) : chunks{simd8<T>::load(ptr), simd8<T>::load(ptr+32)} { __builtin_trap() /* STUB: not implemented */; }
    ...
    simdjson_inline simd8x64<T> bit_or(const T m) const { __builtin_trap() /* STUB: not implemented */; }
